            ...
            if (isLogin) {
                signInWithEmailAndPassword(auth, formValues.emailOrPhone, formValues.password)
                    .then((userCredential) => {
                        ...
                        navigate('/dashboard'); // Navigate to dashboard/header section
                    })
                    .catch((error) => {
    ...
    const handleGoogleSignIn = () => {
        signInWithPopup(auth, googleProvider)
            .then((result) => {
                ...
                onLogin(); // Call onLogin to update authentication state
                navigate('/header'); // Navigate to dashboard/header section
            })
            .catch((error) => {
                console.error(error.message);
                ...
                {isLogin ? (
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3 text-left">
                            <a href="#w" className="text-blue-800">Forgot Password?</a>
                        </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="text-center">
                            ...
                            <button type="button" className="text-blue-800" onClick={switchToLogin}>Login</button>
                        </div>
                    </form>
                )}
            </div>
